...
def main():
    ...
    parser.add_argument("-m", "--masks", type=str, choices=["lung", "lung_left", "lung_right",
                                                            "vertebrae", "ribs", "vertebrae_ribs", "heart", "pelvis",
                                                            "body"],
...
masks = ["lung", "vertebrae", "ribs", "vertebrae_ribs", "heart", "pelvis", "body", 'kidney', 'kidney', 'adrenal', 'gluteus', "autochthon", "clavicula", 'femur']
